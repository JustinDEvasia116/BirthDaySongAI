...
class Profiles(models.Model):
    ...
    generated_lyrics = models.CharField(max_length=5000,blank=True, null=True)
    petname = models.CharField(max_length=200,blank=True, null=True)
    angry = models.CharField(max_length=200,blank=True, null=True)
    ...
    smile = models.CharField(max_length=200,blank=True, null=True)
